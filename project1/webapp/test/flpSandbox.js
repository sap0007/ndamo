		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Banking",
									"targetURL": "#ndkpcomproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ndkpcomproject1-display": {
								"semanticObject": "ndkpcomproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nd.kp.com.project1",
									"url": sap.ui.require.toUrl("nd/kp/com/project1")
								}
							}
						}
					}
